Feature: Demo :
  ...
  Scenario: The user first creates a registration from the registration page.
    ...
    And enter valid ssn no "345-23-8802" demo
    And enter valid first name
    And enter valid last name
    And enter valid adress
    And enter valid phone number
    And enter valid username "Team62DemoUser002" demo
   ...
   Scenario: Employee creates two accounts for the user.
     ...
     Then User enter "DemoTeam62Account005" in the Description and "5500" in the balance boxes
     ...
     Then User clicks to Create a new Account button
     Then User enter "DemoTeam62Account006 " in the Description and "5500" in the balance boxes
     Then User enter the later Date at the time of creation time.
     Then User enter Save button.
     And User checks if new account has been created demo
  ...
  Scenario:  Employee registers the user.
    ...
    Then User enter a valid SSN nummer "345-23-8802" in SSN box
    ...
    And select from accounts  "DemoTeam62Account003" and "DemoTeam62Account004" accounts
    #And select from accounts  "DemoTeam62Account003" accounts
    Then User enter Save button.
    And user logged out
  ...
  Scenario: Admin activates the user.
    ...
    And click Activate button "team62demouser002"
    And user logged out

  Scenario: The user logs into his own account and creates a transfer between the two accounts.
    And click sign in option
    And enter valid customer username "Team62DemoUser002"
    ...
    And Select fromaccount "DemoTeam62Account12" and toaccount "DemoTeam62Account13"
    And enter "5" to balance box
    And enter "Team62DemoDenemeTransfer" in description box

...
public class PDFGenerator {
    ...
    public static void pdfGeneratorRowsAndCellsWithList(String header, List <Customer6> list, String fileName){
...
//  pdfGeneratorRowsAndCells("pdf2","pdf_ders2.pdf");
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirst5(String header, List <Customer6> list, String fileName){
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToTen(String header, List <Customer6> list, String fileName){
